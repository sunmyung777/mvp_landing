      ...
      <div className="container mx-auto px-6">
        ...
        >
          <div className="col-span-12 md:col-span-4 md:col-start-2">
            <h2 className="font-display text-6xl md:text-7xl font-bold text-gray-900 tracking-tight">
              About
              <br />
              <span className="text-gray-300">Re:joice</span>
            </h2>
          </div>
          <div className="col-span-12 md:col-span-5">
            <p className="text-gray-600 text-xl font-light leading-relaxed">
              우리의 일상 속에서
              <br />
              <span className="font-medium">하나님을 경험하는</span>
              <br />
              방법을 제안합니다
            </p>
          </div>
        ...
        <div className="space-y-40">
          ...
          <div className="grid grid-cols-12 gap-8 items-center">
            ...
            >
              <div className="relative">
                <motion.div
                  ...
                  className="absolute -top-8 -left-8 w-32 h-32 bg-black rounded-full"
                ></motion.div>
                <motion.img
            ...
            >
              <h3 className="text-4xl font-bold text-gray-900 mb-12">Problem</h3>
              <div className="space-y-12">
                ...
                >
                  <h4 className="text-xl font-medium text-gray-800 mb-3">버거운 일상</h4>
                ...
                >
                  <h4 className="text-xl font-medium text-gray-800 mb-3">통합 공간의 부재</h4>
                  <p className="text-gray-600 leading-relaxed">
                ...
                >
                  <h4 className="text-xl font-medium text-gray-800 mb-3">미학적 간극</h4>
                  <p className="text-gray-600 leading-relaxed">
          ...
          <div className="grid grid-cols-12 gap-8 items-center">
            ...
            >
              <h3 className="text-4xl font-bold text-gray-900 mb-12">Goal</h3>
              <div className="space-y-8">
                ...
                >
                  나의 하루가 곧
                  <br />
                  <span className="font-medium">예배가 되는 삶</span>
                </motion.p>
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              <div className="relative">
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ duration: 1.2 }}
                  className="absolute -bottom-8 -right-8 w-40 h-40 bg-black rounded-full"
                ></motion.div>
                <motion.img
                  whileHover={{ scale: 1.02 }}
                  transition={{ duration: 0.3 }}
